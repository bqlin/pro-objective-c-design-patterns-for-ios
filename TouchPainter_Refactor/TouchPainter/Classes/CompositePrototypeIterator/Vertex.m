...
- (instancetype)initWithCoder:(NSCoder *)decoder {
    if (self = [super init]) {
        self.location = [(NSValue *)[decoder decodeObjectForKey:VertexLocationKey] CGPointValue];
    }
    return self;
}

- (void)encodeWithCoder:(NSCoder *)coder {
    [coder encodeObject:[NSValue valueWithCGPoint:self.location] forKey:VertexLocationKey];
}
